...
Figure 6 and related supplementary figures (S19-S20). Plots are
...
```
    ...
    ## Warning in colnames(df.covid.w) == c("Day.y", "Public.ID.y"): longer object
...
proteins <- names(df.select)[!(names(df.select) %in% c(colnames(metadata_filtered),"nmf1","nmf2","nmf3","nmf4","nmf5","nmf6","nmf7"))]

storage <- list()
for(i in proteins){
  storage[[i]] <- wilcox.test(get(i) ~ nmf1, df.select)
}
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

``` r
p2
```

![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-12-2.png)<!-- -->

``` r
p3
```

![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-12-3.png)<!-- -->

``` r
p4
```

![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-12-4.png)<!-- -->

``` r
p6
```

![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-12-5.png)<!-- -->

``` r
p7
```

![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-12-6.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
```
    ...
    ## Warning in wilcox.test.default(x = c(-4.7875, -3.8698, -5.0291, -4.989, : cannot
    ## compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-2.2665, -2.2026, -2.4954, -0.7851, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-0.273, 0.1609, -0.1009, 0.0306, -0.1777, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-0.4086, -1.0552, -0.6621, -0.3406, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-0.6236, 0.439, -1.04, -0.9699, -0.1877, :
    ## cannot compute exact p-value with ties
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
```
    ...
    ## Warning in wilcox.test.default(x = c(0.3443, 0.4298, 0.1309, 0.0402, 0.4095, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-0.8255, -0.9066, -0.6078, -1.2873, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-1.2837, -1.5225, -1.1723, -1.8177, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(2.3087, 2.5396, 0.854, 1.4953, 2.0683, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(0.0534, 0.228, 0.9904, 0.1524, 0.037, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-2.1566, -2.7313, -2.2007, -2.2255, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(-0.8855, -0.6448, -0.37, -0.5552,
    ## -0.2266, : cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(1.6997, 1.1229, 1.7677, 3.5409, 1.3708, :
    ## cannot compute exact p-value with ties

    ## Warning in wilcox.test.default(x = c(0.3621, 0.1611, 0.4587, 0.563, 0.2565, :
    ## cannot compute exact p-value with ties
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](Figure6_S19-S20_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
```
    ...
    ## [10] withr_2.4.2            tidyselect_1.1.1       bit_4.0.4             
    ## [13] curl_4.3.2             compiler_4.1.1         DelayedArray_0.18.0   
    ## [16] labeling_0.4.2         scales_1.1.1           genefilter_1.74.0     
    ## [19] digest_0.6.27          foreign_0.8-81         rmarkdown_2.10        
    ## [22] rio_0.5.27             XVector_0.32.0         pkgconfig_2.0.3       
    ## [25] htmltools_0.5.2        highr_0.9              fastmap_1.1.0         
    ## [28] rlang_0.4.11           readxl_1.3.1           RSQLite_2.2.8         
    ## [31] farver_2.1.0           generics_0.1.0         BiocParallel_1.26.2   
    ## [34] zip_2.2.0              car_3.0-11             RCurl_1.98-1.4        
    ## [37] magrittr_2.0.1         GenomeInfoDbData_1.2.6 Matrix_1.3-4          
    ## [40] Rcpp_1.0.7             munsell_0.5.0          fansi_0.5.0           
    ## [43] abind_1.4-5            lifecycle_1.0.0        stringi_1.7.4         
    ## [46] yaml_2.2.1             carData_3.0-4          zlibbioc_1.38.0       
    ## [49] grid_4.1.1             blob_1.2.2             forcats_0.5.1         
    ## [52] crayon_1.4.1           lattice_0.20-44        splines_4.1.1         
    ## [55] Biostrings_2.60.2      haven_2.4.3            annotate_1.70.0       
    ## [58] hms_1.1.0              KEGGREST_1.32.0        locfit_1.5-9.4        
    ## [61] pillar_1.6.2           ggsignif_0.6.2         geneplotter_1.70.0    
    ## [64] XML_3.99-0.7           glue_1.4.2             evaluate_0.14         
    ## [67] data.table_1.14.0      png_0.1-7              vctrs_0.3.8           
    ## [70] cellranger_1.1.0       gtable_0.3.0           purrr_0.3.4           
    ## [73] tidyr_1.1.3            assertthat_0.2.1       cachem_1.0.6          
    ## [76] xfun_0.25              xtable_1.8-4           broom_0.7.9           
    ## [79] rstatix_0.7.0          survival_3.2-13        tibble_3.1.4          
