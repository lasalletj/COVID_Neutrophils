...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-13-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-18-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-20-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-22-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-24-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-26-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-28-1.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-30-1.png)

``` r
p2
```

![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-30-2.png)
...
![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-32-1.png)

``` r
p2
```

![](Figure3_S13_files/figure-markdown_github/unnamed-chunk-32-2.png)

``` r
gmt.file <- gmtPathways(paste0(prefix,"all_gene_sets.gmt"))

metadata_filtered$GO_DEFENSE_RESPONSE_TO_VIRUS <- Pathway_scoring("GO_DEFENSE_RESPONSE_TO_VIRUS")
metadata_filtered$HALLMARK_HYPOXIA <- Pathway_scoring("HALLMARK_HYPOXIA")
metadata_filtered$GO_HEXOSE_CATABOLIC_PROCESS <- Pathway_scoring("GO_HEXOSE_CATABOLIC_PROCESS")
metadata_filtered$HALLMARK_GLYCOLYSIS <- Pathway_scoring("HALLMARK_GLYCOLYSIS")
metadata_filtered$HALLMARK_MTORC1_SIGNALING <- Pathway_scoring("HALLMARK_MTORC1_SIGNALING")
metadata_filtered$HALLMARK_FATTY_ACID_METABOLISM <- Pathway_scoring("HALLMARK_FATTY_ACID_METABOLISM")
metadata_filtered$GO_NADP_METABOLIC_PROCESS <- Pathway_scoring("GO_NADP_METABOLIC_PROCESS")
metadata_filtered$GO_SYNAPTIC_TRANSMISSION_GLUTAMATERGIC <- Pathway_scoring("GO_SYNAPTIC_TRANSMISSION_GLUTAMATERGIC")
metadata_filtered$GO_TRICARBOXYLIC_ACID_CYCLE <- Pathway_scoring("GO_TRICARBOXYLIC_ACID_CYCLE")
metadata_filtered$HALLMARK_MYC_TARGETS_V1 <- Pathway_scoring("HALLMARK_MYC_TARGETS_V1")
metadata_filtered$HALLMARK_OXIDATIVE_PHOSPHORYLATION <- Pathway_scoring("HALLMARK_OXIDATIVE_PHOSPHORYLATION")
metadata_filtered$GO_RIBOSOME_BIOGENESIS <- Pathway_scoring("GO_RIBOSOME_BIOGENESIS")
metadata_filtered$GO_RESPIRATORY_ELECTRON_TRANSPORT_CHAIN <- Pathway_scoring("GO_RESPIRATORY_ELECTRON_TRANSPORT_CHAIN")

metadata_covidp <- metadata_filtered[metadata_filtered$COVID=="Positive"&metadata_filtered$Day %in% c("D0","D3","D7"),]
metadata_covidp$Acuity.max <- factor(metadata_covidp$Acuity.max, levels = c("5","4","3","2","1"))
p2 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(GO_DEFENSE_RESPONSE_TO_VIRUS), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("GO_DEFENSE_RESPONSE_TO_VIRUS") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.GO_DEFENSE_RESPONSE_TO_VIRUS.pdf",p2)

p3 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(HALLMARK_HYPOXIA), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("HALLMARK_HYPOXIA") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.HALLMARK_HYPOXIA.pdf",p3)

p4 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(GO_HEXOSE_CATABOLIC_PROCESS), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("GO_HEXOSE_CATABOLIC_PROCESS") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.GO_HEXOSE_CATABOLIC_PROCESS.pdf",p4)

p5 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(HALLMARK_GLYCOLYSIS), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("HALLMARK_GLYCOLYSIS") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.HALLMARK_GLYCOLYSIS.pdf",p5)

p6 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(HALLMARK_MTORC1_SIGNALING), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("HALLMARK_MTORC1_SIGNALING") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.HALLMARK_MTORC1_SIGNALING.pdf",p6)

p7 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(HALLMARK_FATTY_ACID_METABOLISM), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("HALLMARK_FATTY_ACID_METABOLISM") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.HALLMARK_FATTY_ACID_METABOLISM.pdf",p7)

p8 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(GO_NADP_METABOLIC_PROCESS), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("GO_NADP_METABOLIC_PROCESS") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.GO_NADP_METABOLIC_PROCESS.pdf",p8)

p9 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(GO_SYNAPTIC_TRANSMISSION_GLUTAMATERGIC), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("GO_SYNAPTIC_TRANSMISSION_GLUTAMATERGIC") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.GO_SYNAPTIC_TRANSMISSION_GLUTAMATERGIC.pdf",p9)

p10 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(GO_TRICARBOXYLIC_ACID_CYCLE), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("GO_TRICARBOXYLIC_ACID_CYCLE") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.GO_TRICARBOXYLIC_ACID_CYCLE.pdf",p10)

p11 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(HALLMARK_MYC_TARGETS_V1), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("HALLMARK_MYC_TARGETS_V1") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.HALLMARK_MYC_TARGETS_V1.pdf",p11)

p12 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(HALLMARK_OXIDATIVE_PHOSPHORYLATION), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("HALLMARK_OXIDATIVE_PHOSPHORYLATION") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.HALLMARK_OXIDATIVE_PHOSPHORYLATION.pdf",p12)

p13 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(GO_RIBOSOME_BIOGENESIS), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("GO_RIBOSOME_BIOGENESIS") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.GO_RIBOSOME_BIOGENESIS.pdf",p13)

p14 <- ggplot(metadata_covidp, aes(x = Day, y = as.numeric(GO_RESPIRATORY_ELECTRON_TRANSPORT_CHAIN), fill = Acuity.max)) + geom_boxplot(outlier.shape = NA) + geom_jitter(alpha = 0.2) + theme_bw() + theme(panel.grid = element_blank(), legend.position = "none") + xlab("AcuityMax") + ylab("GO_RESPIRATORY_ELECTRON_TRANSPORT_CHAIN") + coord_fixed(ratio = 1.5) + scale_fill_manual(values = c("seagreen","lightgreen","lightyellow","orange",vermillion)) + stat_compare_means()
#ggsave("Acuity.GO_RESPIRATORY_ELECTRON_TRANSPORT_CHAIN.pdf",p14)
```
...
```
    ...
    ##  [1] glmnet_4.1-3                Matrix_1.4-0               
    ##  [3] caret_6.0-91                lattice_0.20-45            
    ##  [5] heatmap3_1.1.9              sjmisc_2.8.9               
    ##  [7] sjlabelled_1.2.0            sjPlot_2.8.10              
    ##  [9] pROC_1.18.0                 lmtest_0.9-40              
    ## [11] zoo_1.8-9                   ggpubr_0.4.0               
    ## [13] fgsea_1.20.0                cowplot_1.1.1              
    ## [15] openxlsx_4.2.5              DESeq2_1.34.0              
    ...
    ## [25] BiocGenerics_0.40.0         dplyr_1.0.7                
    ## [27] plyr_1.8.6                  RColorBrewer_1.1-2         
    ## [29] ggrepel_0.9.1               ggplot2_3.3.5              
    ## [31] knitr_1.37                 
    ## 
    ## loaded via a namespace (and not attached):
    ##   [1] backports_1.4.1        fastmatch_1.1-3        splines_4.1.2         
    ##   [4] BiocParallel_1.28.3    listenv_0.8.0          digest_0.6.29         
    ##   [7] foreach_1.5.2          htmltools_0.5.2        fansi_1.0.2           
    ##  [10] magrittr_2.0.1         memoise_2.0.1          recipes_0.2.0         
    ##  [13] globals_0.14.0         fastcluster_1.2.3      Biostrings_2.62.0     
    ##  [16] annotate_1.72.0        modelr_0.1.8           gower_1.0.0           
    ##  [19] hardhat_0.2.0          colorspace_2.0-2       blob_1.2.2            
    ##  [22] xfun_0.29              crayon_1.4.2           RCurl_1.98-1.5        
    ##  [25] genefilter_1.76.0      lme4_1.1-28            survival_3.2-13       
    ##  [28] iterators_1.0.14       glue_1.6.0             gtable_0.3.0          
    ##  [31] ipred_0.9-12           zlibbioc_1.40.0        emmeans_1.7.3         
    ##  [34] XVector_0.34.0         DelayedArray_0.20.0    sjstats_0.18.1        
    ##  [37] car_3.0-12             shape_1.4.6            future.apply_1.8.1    
    ##  [40] abind_1.4-5            scales_1.1.1           mvtnorm_1.1-3         
    ##  [43] DBI_1.1.2              rstatix_0.7.0          ggeffects_1.1.2       
    ##  [46] Rcpp_1.0.8             xtable_1.8-4           performance_0.9.0     
    ##  [49] bit_4.0.4              lava_1.6.10            prodlim_2019.11.13    
    ##  [52] datawizard_0.4.0       httr_1.4.2             ellipsis_0.3.2        
    ##  [55] farver_2.1.0           pkgconfig_2.0.3        XML_3.99-0.8          
    ##  [58] nnet_7.3-17            locfit_1.5-9.4         utf8_1.2.2            
    ##  [61] labeling_0.4.2         reshape2_1.4.4         tidyselect_1.1.1      
    ##  [64] rlang_0.4.12           effectsize_0.6.0.1     AnnotationDbi_1.56.2  
    ##  [67] munsell_0.5.0          tools_4.1.2            cachem_1.0.6          
    ##  [70] generics_0.1.1         RSQLite_2.2.9          broom_0.7.11          
    ##  [73] evaluate_0.14          stringr_1.4.0          fastmap_1.1.0         
    ##  [76] yaml_2.2.1             ModelMetrics_1.2.2.2   bit64_4.0.5           
    ##  [79] zip_2.2.0              purrr_0.3.4            KEGGREST_1.34.0       
    ##  [82] future_1.23.0          nlme_3.1-155           compiler_4.1.2        
    ##  [85] png_0.1-7              ggsignif_0.6.3         tibble_3.1.6          
    ##  [88] geneplotter_1.72.0     stringi_1.7.6          highr_0.9             
    ##  [91] parameters_0.17.0      nloptr_2.0.0           vctrs_0.3.8           
    ##  [94] pillar_1.6.4           lifecycle_1.0.1        estimability_1.3      
    ##  [97] data.table_1.14.2      bitops_1.0-7           insight_0.17.0        
    ## [100] R6_2.5.1               gridExtra_2.3          parallelly_1.30.0     
    ## [103] codetools_0.2-18       boot_1.3-28            MASS_7.3-55           
    ## [106] assertthat_0.2.1       withr_2.4.3            GenomeInfoDbData_1.2.7
    ## [109] bayestestR_0.11.5      parallel_4.1.2         grid_4.1.2            
    ## [112] rpart_4.1-15           timeDate_3043.102      tidyr_1.1.4           
    ## [115] class_7.3-20           minqa_1.2.4            rmarkdown_2.11        
    ## [118] carData_3.0-5          lubridate_1.8.0
