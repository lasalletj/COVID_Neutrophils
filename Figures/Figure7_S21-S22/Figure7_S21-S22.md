...
res <- read.xlsx(paste0(prefix,"Tables/TableS2.xlsx"), sheet = 5)
...
res <- read.xlsx(paste0(prefix,"Tables/TableS2.xlsx"), sheet = 8)
res <- res[rev(order(res$rank)),]
severe <- res[res$padj < 0.05 & res$rank > 0,]
nonsevere <- res[res$padj < 0.05 & res$rank < 0,]
severe$cluster <- "severe"
...
res <- read.xlsx(paste0(prefix,"Tables/TableS2.xlsx"), sheet = 11)
res <- res[rev(order(res$rank)),]
severe <- res[res$padj < 0.05 & res$rank > 0,]
nonsevere <- res[res$padj < 0.05 & res$rank < 0,]
severe$cluster <- "severe"
...
```
    ...
    ##  [3] ggplotify_0.0.9             DESeq2_1.32.0              
