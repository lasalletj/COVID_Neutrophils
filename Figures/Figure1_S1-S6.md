...
Figure 1 and related supplementary figures (S1-S6). Plots are
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

``` r
p2
```

![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-15-2.png)<!-- -->

``` r
p3
```

![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-15-3.png)<!-- -->

``` r
p4
```

![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-15-4.png)<!-- -->

``` r
p8
```

![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-15-5.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

Next we want to get an estimate of the sample purity since we performed
bulk RNA-seq of enriched neutrophils. In order to do so, we need a
reference single-cell RNA-seq dataset for deconvolution using
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->

``` r
p2
```

![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-36-2.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-38-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-40-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-40-2.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-42-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-42-2.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-44-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-44-2.png)<!-- -->

We next generate UMAPs for sample visualization in Figure 1E. Figure S5
features projections of many clinical parameters and quality control
parameters - as is the case with other parameters in the study, not all
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-46-1.png)<!-- -->
...
Neutrophil\_DESeq2.R to import the function. As we will see, if we do
not make a correction for plasmablast contamination, we will have many
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-49-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-53-1.png)<!-- -->

``` r
p2
```

![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-53-2.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-55-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-57-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-59-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-61-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-63-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-67-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-68-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-70-1.png)<!-- -->
...
![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-72-1.png)<!-- -->

``` r
cowplot::plot_grid(p7,p8,p9,p10,p11,p12,ncol=3)
```

![](Figure1_S1-S6_files/figure-gfm/unnamed-chunk-73-1.png)<!-- -->
...
```
    ...
    ##  [31] fastcluster_1.2.3      productplots_0.1.1     R6_2.5.1              
    ##  [34] locfit_1.5-9.4         bitops_1.0-7           spatstat.utils_2.2-0  
    ##  [37] cachem_1.0.6           DelayedArray_0.18.0    assertthat_0.2.1      
    ##  [40] promises_1.2.0.1       scales_1.1.1           gtable_0.3.0          
    ##  [43] globals_0.14.0         goftest_1.2-2          rlang_0.4.11          
    ##  [46] genefilter_1.74.0      splines_4.1.1          rstatix_0.7.0         
    ##  [49] lazyeval_0.2.2         spatstat.geom_2.2-2    broom_0.7.9           
    ##  [52] yaml_2.2.1             reshape2_1.4.4         abind_1.4-5           
    ##  [55] backports_1.2.1        httpuv_1.6.2           tools_4.1.1           
    ##  [58] ellipsis_0.3.2         spatstat.core_2.3-0    ggridges_0.5.3        
    ##  [61] Rcpp_1.0.7             zlibbioc_1.38.0        purrr_0.3.4           
    ##  [64] RCurl_1.98-1.4         rpart_4.1-15           openssl_1.4.5         
    ##  [67] deldir_0.2-10          pbapply_1.4-3          zoo_1.8-9             
    ##  [70] haven_2.4.3            cluster_2.1.2          magrittr_2.0.1        
    ##  [73] data.table_1.14.0      RSpectra_0.16-0        scattermore_0.7       
    ##  [76] lmtest_0.9-38          RANN_2.6.1             fitdistrplus_1.1-5    
    ##  [79] hms_1.1.0              patchwork_1.1.1        mime_0.11             
    ##  [82] evaluate_0.14          xtable_1.8-4           XML_3.99-0.7          
    ##  [85] rio_0.5.27             readxl_1.3.1           gridExtra_2.3         
    ##  [88] compiler_4.1.1         tibble_3.1.4           KernSmooth_2.23-20    
    ##  [91] crayon_1.4.1           htmltools_0.5.2        mgcv_1.8-36           
    ##  [94] later_1.3.0            tidyr_1.1.3            geneplotter_1.70.0    
    ##  [97] DBI_1.1.1              MASS_7.3-54            Matrix_1.3-4          
    ## [100] car_3.0-11             igraph_1.2.6           forcats_0.5.1         
    ## [103] pkgconfig_2.0.3        foreign_0.8-81         plotly_4.9.4.1        
    ## [106] spatstat.sparse_2.0-0  annotate_1.70.0        XVector_0.32.0        
    ## [109] stringr_1.4.0          digest_0.6.27          sctransform_0.3.2     
    ## [112] RcppAnnoy_0.0.19       spatstat.data_2.1-0    Biostrings_2.60.2     
    ## [115] rmarkdown_2.10         cellranger_1.1.0       leiden_0.3.9          
    ## [118] fastmatch_1.1-3        uwot_0.1.10            curl_4.3.2            
    ## [121] shiny_1.6.0            lifecycle_1.0.0        nlme_3.1-152          
    ## [124] jsonlite_1.7.2         carData_3.0-4          viridisLite_0.4.0     
    ## [127] askpass_1.1            fansi_0.5.0            pillar_1.6.2          
    ## [130] lattice_0.20-44        KEGGREST_1.32.0        fastmap_1.1.0         
    ## [133] httr_1.4.2             survival_3.2-13        glue_1.4.2            
    ## [136] zip_2.2.0              png_0.1-7              bit_4.0.4             
    ## [139] stringi_1.7.4          blob_1.2.2             memoise_2.0.0         
    ## [142] irlba_2.3.3            future.apply_1.8.1
