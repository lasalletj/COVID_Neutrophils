...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-13-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-15-1.png)

``` r
p2
```

![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-15-2.png)

``` r
p3
```

![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-15-3.png)

``` r
p4
```

![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-15-4.png)

``` r
p8
```

![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-15-5.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-17-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-18-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-21-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-24-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-26-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-28-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-30-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-32-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-34-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-36-1.png)

``` r
p2
```

![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-36-2.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-38-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-40-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-40-2.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-42-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-42-2.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-44-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-44-2.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-46-1.png)

We perform differential expression to test for genes and pathways associated with COVID-19 infection. We use the helper script Neutrophil\_DESeq2.R to import the function. As we will see, if we do not make a correction for plasmablast contamination, we will have many highly expressed immunoglobulin genes in the COVID+ side.
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-49-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-53-1.png)

``` r
p2
```

![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-53-2.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-55-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-57-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-59-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-61-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-63-1.png)

Highlight genes associated with severity (Figure 2) on the volcano plot for COVID+ vs. COVID-

``` r
#severity associated genes for Day 0
res0 <- read.xlsx(paste0(prefix,"Tables/TableS2.xlsx"), sheet = 13)
res0_subset <- res0[res0$pvalue<1e-4&abs(res0$log2FoldChange_severe_nonsevere)>0.5,]
combo_severitycolor <- combo
combo_severitycolor$color <- 0
combo_severitycolor[combo_severitycolor$symbol %in% res0_subset[res0_subset$log2FoldChange_severe_nonsevere>0,]$symbol,]$color <- 1
combo_severitycolor[combo_severitycolor$symbol %in% res0_subset[res0_subset$log2FoldChange_severe_nonsevere<0,]$symbol,]$color <- -1
combo_severitycolor$labels <- 0
combo_severitycolor[combo_severitycolor$symbol %in% c("IL1R1","IL1R2","ARG1","CD177","MCEMP1","HLA-DMA", "HLA-DMB", "HLA-DRA", "HLA-DRB1", "HLA-DQA1","SERPINB2","ZBTB16"),]$labels <- 1
my.cols.severity <- brewer.pal(3,"RdBu")
plotposnegseverity <- ggplot(combo_severitycolor, aes(x = log2fc, y = log10p)) + geom_point(data = subset(combo_severitycolor, color == 0), colour = "grey") + geom_point(data = subset(combo_severitycolor, color == 1), colour = my.cols.severity[1]) + geom_point(data = subset(combo_severitycolor, color == -1), colour = my.cols.severity[3]) + geom_text_repel(data = subset(combo_severitycolor, labels == 1), aes(label = as.character(symbol)),min.segment.length = unit(0, 'lines'))  + theme_bw() + ylab("-Log10(p-value)") + xlab("Log2(FC)") + annotate("text", x=1.3, y=25, label= "COVID+", colour = my.cols[2]) + annotate("text", x=-1.2, y=25, label= "COVID-", colour = my.cols[1]) + coord_fixed(ratio = .21) + theme(panel.grid = element_blank()) + geom_hline(linetype="dashed",yintercept=4)

combo_severitycolor$label2 <- 0
combo_severitycolor[combo_severitycolor$color!=0 & combo_severitycolor$log10p>=4,]$label2 <- 1
plotposnegseverity3 <- ggplot(combo_severitycolor, aes(x = log2fc, y = log10p)) + geom_point(data = subset(combo_severitycolor, color == 0), colour = "grey") + geom_point(data = subset(combo_severitycolor, color == 1), colour = my.cols.severity[1]) + geom_point(data = subset(combo_severitycolor, color == -1), colour = my.cols.severity[3]) + geom_text_repel(data = subset(combo_severitycolor, label2 == 1), aes(label = as.character(symbol)),min.segment.length = unit(0, 'lines'))  + theme_bw() + ylab("-Log10(p-value)") + xlab("Log2(FC)") + annotate("text", x=1.3, y=25, label= "COVID+", colour = my.cols[2]) + annotate("text", x=-1.2, y=25, label= "COVID-", colour = my.cols[1]) + coord_fixed(ratio = .21) + theme(panel.grid = element_blank()) + geom_hline(linetype="dashed",yintercept=4)
```
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-68-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-69-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-71-1.png)
...
![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-73-1.png)

``` r
cowplot::plot_grid(p7,p8,p9,p10,p11,p12,ncol=3)
```

![](Figure1_S1-S6_files/figure-markdown_github/unnamed-chunk-74-1.png)
...
```
    ...
    ## [25] ggplot2_3.3.5               knitr_1.37                 
    ## 
    ## loaded via a namespace (and not attached):
    ##   [1] backports_1.4.1        fastmatch_1.1-3        igraph_1.2.11         
    ##   [4] lazyeval_0.2.2         splines_4.1.2          BiocParallel_1.28.3   
    ##   [7] listenv_0.8.0          scattermore_0.7        digest_0.6.29         
    ##  [10] htmltools_0.5.2        fansi_1.0.2            magrittr_2.0.1        
    ##  [13] memoise_2.0.1          tensor_1.5             cluster_2.1.2         
    ##  [16] ROCR_1.0-11            fastcluster_1.2.3      globals_0.14.0        
    ##  [19] Biostrings_2.62.0      annotate_1.72.0        askpass_1.1           
    ##  [22] spatstat.sparse_2.1-0  colorspace_2.0-2       blob_1.2.2            
    ##  [25] xfun_0.29              crayon_1.4.2           RCurl_1.98-1.5        
    ##  [28] jsonlite_1.7.3         genefilter_1.76.0      spatstat.data_2.1-2   
    ##  [31] survival_3.2-13        zoo_1.8-9              glue_1.6.0            
    ##  [34] polyclip_1.10-0        gtable_0.3.0           zlibbioc_1.40.0       
    ##  [37] XVector_0.34.0         leiden_0.3.9           DelayedArray_0.20.0   
    ##  [40] car_3.0-12             future.apply_1.8.1     abind_1.4-5           
    ##  [43] scales_1.1.1           DBI_1.1.2              rstatix_0.7.0         
    ##  [46] miniUI_0.1.1.1         Rcpp_1.0.8             viridisLite_0.4.0     
    ##  [49] xtable_1.8-4           reticulate_1.23        spatstat.core_2.3-2   
    ##  [52] bit_4.0.4              htmlwidgets_1.5.4      httr_1.4.2            
    ##  [55] ellipsis_0.3.2         ica_1.0-2              farver_2.1.0          
    ##  [58] pkgconfig_2.0.3        XML_3.99-0.8           uwot_0.1.11           
    ...
    ##  [73] generics_0.1.1         RSQLite_2.2.9          broom_0.7.11          
    ##  [76] ggridges_0.5.3         evaluate_0.14          stringr_1.4.0         
    ##  [79] fastmap_1.1.0          yaml_2.2.1             goftest_1.2-3         
    ##  [82] bit64_4.0.5            fitdistrplus_1.1-6     zip_2.2.0             
    ##  [85] purrr_0.3.4            RANN_2.6.1             KEGGREST_1.34.0       
    ##  [88] pbapply_1.5-0          future_1.23.0          nlme_3.1-155          
    ##  [91] mime_0.12              compiler_4.1.2         plotly_4.10.0         
    ##  [94] png_0.1-7              ggsignif_0.6.3         spatstat.utils_2.3-0  
    ##  [97] tibble_3.1.6           geneplotter_1.72.0     stringi_1.7.6         
    ## [100] highr_0.9              RSpectra_0.16-0        lattice_0.20-45       
    ## [103] Matrix_1.4-0           vctrs_0.3.8            pillar_1.6.4          
    ## [106] lifecycle_1.0.1        spatstat.geom_2.3-1    lmtest_0.9-40         
    ...
    ## [118] gridExtra_2.3          parallelly_1.30.0      codetools_0.2-18      
    ## [121] MASS_7.3-55            assertthat_0.2.1       openssl_1.4.6         
    ## [124] withr_2.4.3            sctransform_0.3.3      GenomeInfoDbData_1.2.7
    ## [127] mgcv_1.8-38            parallel_4.1.2         grid_4.1.2            
    ## [130] rpart_4.1-15           tidyr_1.1.4            rmarkdown_2.11        
    ## [133] carData_3.0-5          Rtsne_0.15             shiny_1.7.1
