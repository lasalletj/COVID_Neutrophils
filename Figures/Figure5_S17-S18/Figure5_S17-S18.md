...
![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-32-2.png)<!-- -->
...
![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-37-2.png)<!-- -->
...
![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-42-2.png)<!-- -->
...
![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-46-1.png)<!-- -->

``` r
cowplot::plot_grid(p4,p5,p6,ncol=3)
```

![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-46-2.png)<!-- -->

Finally we analyze the results of the MPO ELISA. First we generate the
standard curve and fit the points using a 4-parameter logistic
...
![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-47-1.png)<!-- -->
...
![](Figure5_S17-S18_files/figure-gfm/unnamed-chunk-49-1.png)<!-- -->
...
```
    ...
    ##  [3] minpack.lm_1.2-1            stringi_1.7.4              
    ##  [5] R2HTML_2.3.2                fgsea_1.18.0               
    ##  [7] DESeq2_1.32.0               SummarizedExperiment_1.22.0
    ##  [9] Biobase_2.52.0              MatrixGenerics_1.4.2       
    ## [11] matrixStats_0.60.1          GenomicRanges_1.44.0       
    ## [13] GenomeInfoDb_1.28.1         IRanges_2.26.0             
    ## [15] S4Vectors_0.30.0            BiocGenerics_0.38.0        
    ## [17] pheatmap_1.0.12             ggplotify_0.0.9            
    ## [19] ggpubr_0.4.0                cowplot_1.1.1              
    ## [21] openxlsx_4.2.4              dplyr_1.0.7                
    ## [23] plyr_1.8.6                  RColorBrewer_1.1-2         
    ## [25] ggrepel_0.9.1               ggplot2_3.3.5              
    ## [27] knitr_1.33                 
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] colorspace_2.0-2       ggsignif_0.6.2         ellipsis_0.3.2        
    ##  [4] rio_0.5.27             XVector_0.32.0         farver_2.1.0          
    ##  [7] bit64_4.0.5            AnnotationDbi_1.54.1   fansi_0.5.0           
    ## [10] codetools_0.2-18       splines_4.1.1          cachem_1.0.6          
    ## [13] geneplotter_1.70.0     broom_0.7.9            annotate_1.70.0       
    ## [16] png_0.1-7              compiler_4.1.1         httr_1.4.2            
    ## [19] backports_1.2.1        assertthat_0.2.1       Matrix_1.3-4          
    ## [22] fastmap_1.1.0          htmltools_0.5.2        tools_4.1.1           
    ## [25] gtable_0.3.0           glue_1.4.2             GenomeInfoDbData_1.2.6
    ## [28] fastmatch_1.1-3        Rcpp_1.0.7             carData_3.0-4         
    ## [31] cellranger_1.1.0       vctrs_0.3.8            Biostrings_2.60.2     
    ## [34] xfun_0.25              stringr_1.4.0          rbibutils_2.2.3       
    ## [37] lifecycle_1.0.0        rstatix_0.7.0          XML_3.99-0.7          
    ## [40] zlibbioc_1.38.0        scales_1.1.1           hms_1.1.0             
    ## [43] yaml_2.2.1             curl_4.3.2             memoise_2.0.0         
    ## [46] gridExtra_2.3          yulab.utils_0.0.2      RSQLite_2.2.8         
    ## [49] highr_0.9              genefilter_1.74.0      zip_2.2.0             
    ## [52] BiocParallel_1.26.2    Rdpack_2.1.2           rlang_0.4.11          
    ## [55] pkgconfig_2.0.3        bitops_1.0-7           evaluate_0.14         
    ## [58] lattice_0.20-44        purrr_0.3.4            tensor_1.5            
    ## [61] labeling_0.4.2         bit_4.0.4              tidyselect_1.1.1      
    ## [64] magrittr_2.0.1         R6_2.5.1               generics_0.1.0        
    ## [67] DelayedArray_0.18.0    DBI_1.1.1              pillar_1.6.2          
    ## [70] haven_2.4.3            foreign_0.8-81         withr_2.4.2           
    ## [73] survival_3.2-13        KEGGREST_1.32.0        abind_1.4-5           
    ## [76] RCurl_1.98-1.4         tibble_3.1.4           crayon_1.4.1          
    ## [79] car_3.0-11             utf8_1.2.2             rmarkdown_2.10        
    ## [82] locfit_1.5-9.4         grid_4.1.1             readxl_1.3.1          
    ## [85] data.table_1.14.0      blob_1.2.2             forcats_0.5.1         
